class_name GodotEssentialsTopDownMovementComponent extends Node2D
...
func move() -> GodotEssentialsTopDownMovementComponent:
	if body:
...
func accelerate(direction: Vector2, delta: float =  get_physics_process_delta_time()) -> GodotEssentialsTopDownMovementComponent:
...
func decelerate(force_stop: bool = false, delta = get_physics_process_delta_time()) -> GodotEssentialsTopDownMovementComponent:
...
func accelerate_to_position(position: Vector2) -> GodotEssentialsTopDownMovementComponent:
	return accelerate(body.global_position.direction_to(position))


func knockback(direction: Vector2, power: float) -> GodotEssentialsTopDownMovementComponent:
...
func change_speed_temporary(new_speed: float, time: float = DEFAULT_TEMPORARY_SPEED_TIME) -> GodotEssentialsTopDownMovementComponent:
